...
#include "ns3/mac8-address.h" //liucm20240906
 ...
 * \ingroup aqua-sim-ng
 *
 * \brief Specialized address for distinguishing nodes and protocol support. 16 bit addresses
 * supported.
 *
 * Inspired by UanAddress but implemented for future modification to adhere to aqua-sim
 * modification.
 */
class AquaSimAddress
{
  public:
    ...
    Mac8Address ConvertToMac8Address(void) const; // liucm20240906
