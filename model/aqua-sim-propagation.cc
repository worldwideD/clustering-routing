...
Time
AquaSimPropagation::PDelay (Ptr<DolphinMobilityModel> s, Ptr<DolphinMobilityModel> r)
{
  NS_LOG_FUNCTION(this);
  return Time::FromDouble((s->GetRealDistanceFrom(r) / ns3::SOUND_SPEED_IN_WATER), Time::S);
}
