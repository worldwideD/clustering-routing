...
/*
 */
#ifndef DOLPHIN_APP_HELPER_H
#define DOLPHIN_APP_HELPER_H
 ...
 * on a set of nodes.
 */
class DolphinApplicationHelper
{
  public:
    /**
     * Create an DolphinApplicationHelper to make it easier to work with OnOffApplications
     *
     ...
     *        to.
     */
    DolphinApplicationHelper(std::string protocol, Address address);

    // For random destination
    DolphinApplicationHelper(std::string protocol, uint32_t n_destinations);
